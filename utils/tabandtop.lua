...
------------------------------------------------
 ...
 myApp.tabBar = widget.newTabBar{
    ...
    left = 0,
    width = myApp.cW,
    backgroundFile = myApp.imgfld .. myApp.tabs.images.backgroundFile,
    tabSelectedLeftFile = myApp.imgfld .. myApp.tabs.images.tabSelectedLeftFile,       
    tabSelectedRightFile = myApp.imgfld .. myApp.tabs.images.tabSelectedRightFile,     
    tabSelectedMiddleFile = myApp.imgfld .. myApp.tabs.images.tabSelectedMiddleFile,       
